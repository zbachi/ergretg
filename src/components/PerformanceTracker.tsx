...
import { BarChart2, TrendingUp, Eye, MousePointer2, Clock, MessageSquare, Plus, Loader2, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-12">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-all shadow-xl">
